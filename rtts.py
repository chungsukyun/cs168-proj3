...
def run_ping(hostname_file_name, num_packets, raw_ping_output_filename, aggregated_ping_output_filename):
    hostnames = []
...
if function_name == "run_ping":
    ...
    run_ping(hostname_file_name, num_packets, raw_ping_output_filename, aggregated_ping_output_filename)
    # raw_ping_dict = {}
    # aggregated_ping_dict = {}
...
def plot_ping_cdf(raw_ping_results_filename, output_cdf_filename):
    ...
    plot.plot(rtt_list, y_list, label="rtt cdf")
    plot.legend()
    plot.grid()
    plot.xlabel("RTT")
    plot.ylabel("Cumulative Fraction of Websites")
